...
\begin{figure}[H]
	...
	\begin{minipage}[h]{0.47\linewidth}
		Alexandr Iliasov \\
		\emph{Role in team: reserve operator-1, decorating robot, Power Design, responsible for the bucket.\\}
...
\begin{figure}[H]
	...
	\begin{minipage}{0.47\linewidth}
		Andrew Nemow\\
		\emph{Role in team: operator-1, responsible for the writing of technical book, responsible for debris collecting systems.\\}
...
\begin{figure}[H]
	\begin{minipage}{0.47\linewidth}
		Gordei Kravzov\\
		\emph{Role in team: development strategy in the game, operator-2, responsible for chassis.\\ }
