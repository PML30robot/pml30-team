...
\begin{figure}[H]
	\begin{minipage}[h]{0.37\linewidth}
		\center{\includegraphics[scale=0.25]{3Engineering/5Team_meetings/days_of_meetings/2015.11.12/images/01}}
		\caption{Prototype of the wheel base}
		\label{Wheelbase1.1}
	\end{minipage}
	\hfill
	\begin{minipage}[h]{0.58\linewidth}
		\center{\includegraphics[scale=0.25]{3Engineering/5Team_meetings/days_of_meetings/2015.11.12/images/02}}
