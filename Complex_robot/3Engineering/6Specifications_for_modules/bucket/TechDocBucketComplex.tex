\subsubsection{Bucket}
  ...
  \begin{figure}[H]
  	\begin{minipage}[h]{1\linewidth}
  		\center{\includegraphics[scale = 0.1]{3Engineering/6Specifications_for_modules/bucket/images/08}}
 ...
 \begin{figure}[H]
  \begin{minipage}[h]{0.49\linewidth}
  	\center{\includegraphics[scale=0.1]{3Engineering/6Specifications_for_modules/bucket/images/Buck_assembled}}
  	\caption{Construction of bucket}
  \end{minipage}
  \begin{minipage}[h]{0.49\linewidth}
  	\center{\includegraphics[width=0.8\linewidth]{3Engineering/6Specifications_for_modules/bucket/images/OnRobot}}
 ...
 \begin{figure}[H]
  \begin{minipage}[h]{0.49\linewidth}
  	\center{\includegraphics[width=0.8\linewidth]{3Engineering/6Specifications_for_modules/bucket/images/Draws}}
  	\caption{Shape and scan of the bucket}
  \end{minipage} 
  \begin{minipage}[h]{0.49\linewidth}
  	\center{\includegraphics[width=0.8\linewidth]{3Engineering/6Specifications_for_modules/bucket/images/BucketScan}}
 ...
 \begin{figure}[H]
  \begin{minipage}[h]{0.49\linewidth}
  	\center{\includegraphics[width=0.8\linewidth]{3Engineering/6Specifications_for_modules/bucket/images/BucketMarking}}
  	\caption{Marking of bucket on the plastic sheet}
  \end{minipage} 
  \begin{minipage}[h]{0.49\linewidth}
  	\center{\includegraphics[width=0.8\linewidth]{3Engineering/6Specifications_for_modules/bucket/images/Bucket2}}
 ...
 \begin{figure}[H]
  \begin{minipage}[h]{0.49\linewidth}
  	\center{\includegraphics[width=0.8\linewidth]{3Engineering/6Specifications_for_modules/bucket/images/wire_prot}}
  	\caption{Protection of rope}
  \end{minipage} 
  \begin{minipage}[h]{0.49\linewidth}
  	\center{\includegraphics[width=0.8\linewidth]{3Engineering/6Specifications_for_modules/bucket/images/Bucket2Test}}
